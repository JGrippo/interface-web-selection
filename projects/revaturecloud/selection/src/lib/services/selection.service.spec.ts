...
describe('SelectionService Tests', () => {
  ...
  const s: SearchParameters = new SearchParameters {
    batch= null, location= 'Tampa', gender= 'M',
    batchMinimumPercentage= null, isCompletelyUnassigned= null,
    hasBedAvailable= null, assigned= null};
  beforeEach(() => {
